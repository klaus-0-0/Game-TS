import { getGameFromRedis, deleteGameFromRedis } from "./chipsAndBombGameLogic.js";
...
const roomPlayers = {};
const roomTurns = {};
const userBombCounts = {};
function rockPaperScissorSoketSetup(io) {
    io.on("connection", (socket) => {
        ...
        socket.on("live-data-send", ({ roomId, myTiles, userId }) => {
            ...
            const bombCount = myTiles.filter((tile) => tile.tile === "bomb").length;
        ...
        socket.on("disconnect", () => {
            ...
            if (disconnectedUserId) {
                ...
                if (readyIndex !== -1)
                    usersReady.splice(readyIndex, 1);
...
//# sourceMappingURL=rockPaperScissorSoketSetup.js.map